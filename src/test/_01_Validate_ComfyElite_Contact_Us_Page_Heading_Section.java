...
public class _01_Validate_ComfyElite_Contact_Us_Page_Heading_Section {
    public static void main(String[] args) {
        ...
        if (driver.getCurrentUrl().equals("https://comfyelite.com/contact-us")) System.out.println("Contact us link button validation PASSED");
        else System.out.println("Contact us link button validation FAILED");

        WebElement comfyEliteLogo = driver.findElement(By.xpath("//div[@data-ux='Block']//img"));
        WebElement heading2 = driver.findElement(By.id("dynamic-tagline-48605"));

        if (comfyEliteLogo.isDisplayed()) System.out.println("Comfy Elite Logo validation PASSED");
        else System.out.println("Comfy Elite Logo validation FAILED");

        if (heading2.isDisplayed() && heading2.getText().equals("High quality comfy pillows and accessories for travel, office and home.")) {
            System.out.println("Heading 2 validation is PASSED");;
